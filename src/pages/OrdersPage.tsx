...
import { Package, Truck, CheckCircle, Clock, AlertTriangle, CreditCard, MapPin } from 'lucide-react';
...
export default function OrdersPage() {
  ...
  const handleUpdateStatus = (orderId: string, newStatus: 'pending' | 'processing' | 'delivered' | 'completed' | 'payment_verification') => {
                ...
                {expandedOrderId === order.id && (
                  <div className="p-6 border-t border-gray-100">
                    <div className="mb-6">
                      ...
                      {/* Admin controls (in a real app, this would be restricted to admin users) */}
                      <div className="mt-4 border-t pt-4">
                        <h4 className="font-medium mb-2 text-sm text-gray-500">Admin Controls</h4>
                        <div className="flex flex-wrap gap-2">
                          ...
                          <button
                            ...
                            className="bg-green-200 text-green-700 px-3 py-1 rounded text-xs hover:bg-green-300"
                          >
                            Set Completed
                          </button>
                        </div>
